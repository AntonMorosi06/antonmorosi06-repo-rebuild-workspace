...
Source repository: AntonMorosi2234/Genetic-algorithm-simulation

Planned role:
Genetic algorithm rocket simulation with Pygame.

Priority:
Medium-High

Current classification:
Public and close to portfolio-ready after cleanup.

MicroBot relevance:
Indirect swarm optimization relevance
